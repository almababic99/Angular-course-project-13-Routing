...
export const appConfig: ApplicationConfig = {
  ...
  providers: [
    ...
    // withRouterConfig({ paramsInheritanceStrategy: 'always' }) ensures that route parameters are always inherited by child routes, 
    // making sure they are available even when navigating to nested paths like /users/:userId/tasks.
  ],
};
